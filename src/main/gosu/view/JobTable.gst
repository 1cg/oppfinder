...
<div ic-src="/jobs/table/${type}/${pager.Current}" ic-poll="5s" ic-transition="none" ic-deps="/jobs/action">
...
<div class="navbar-right" ic-src="/jobs/table/pager/${type}/${pager.Current}" ic-poll="4s" ic-transition="none" ic-deps="/jobs/action">
